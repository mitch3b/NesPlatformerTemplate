...
const unsigned char PALETTE[]={
  ...
  //Sprites
  BLACK,DARK_PURPLE,PINK,LIGHT_PINK,
  BLACK,LIGHT_PINK,PINK,LIGHT_PINK,
  BLACK,DARK_RED,RED,LIGHT_RED,
  BLACK,DARK_GREEN,LIGHT_CYAN,DARK_PURPLE
};

const unsigned char PALETTE_HIDDEN[]={
  BLACK,BLACK,PINK,BLACK,BLACK,LIGHT_PINK,PINK,LIGHT_PINK,BLACK,DARK_RED,RED,LIGHT_RED,BLACK,DARK_GREEN,LIGHT_CYAN,DARK_PURPLE,
    //Sprites
  BLACK,DARK_PURPLE,PINK,LIGHT_PINK,
  BLACK,LIGHT_PINK,PINK,LIGHT_PINK,
  BLACK,DARK_RED,RED,LIGHT_RED,
